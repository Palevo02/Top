...
public class Main {
    ...
    public static boolean equals(String str) throws Exception{
    ...
    public static String toLowerCase()throws Exception{
    ...
    public static String toUpperCase()throws Exception{
    ...
    public static int indexOf(char c)throws Exception{
    ...
    public static int indexOf(String c)throws Exception{
        //- возвращает index первого вхождения в противном случаи -1
    ...
    public static int indexOf (char c , int fromIndex)throws Exception{
    ...
    public static int lastIndexOf(char c)throws Exception{
    ...
    public static int lastIndexOf(String c)throws Exception{
        // - возвращает index первого вхождения c конца  в противном случаи -1
        char [] newArr = c.toCharArray();
        boolean isCheak = false;
        for (int i = arr.length-1; i >= 0; i--) {
    ...
    public static String trim()throws Exception{
    ...
    public static boolean startsWith(String str)throws Exception{
    ...
    public static boolean endsWith(String str)throws Exception{
    ...
    public static boolean equalsIgnoreCase(String str)throws Exception{
    ...
    public static char[] toCharArray(String str)throws Exception{
